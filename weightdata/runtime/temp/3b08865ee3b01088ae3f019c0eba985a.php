<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\code\php\weightdata\weightdata/application/index\view\index\index.html";i:1510638302;}*/ ?>
...
<head>
    ...
    <script src="https://cdn.bootcss.com/respond.__JS__/1.4.2/respond.min.js"></script>
    <![endif]-->
</head>
<body>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            <p class="navbar-brand">&nbsp;称重系统数据展示</p>
...
<div id="main">
    <div class="container-fluid">
        <div class="row" id="row-1">
            <div class="col-lg-12">
                <P id="main-title" style="display: none">称重系统数据展示</P>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <p id="small-title" style="display: none">Weight data display</p>
            </div>
        </div>
